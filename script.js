...
/* ===== DATA ===== */
const PRODUCTS = [
  {id:101, name:"BLODBOK", price:44, img:"images/bougie1.jpg", desc:"Bougie délicate, parfum léger."},
  {id:102, name:"LÖVSKOGSLUND", price:55, img:"images/bougie2.jpg", desc:"Parfum boisé et doux."},
  {id:103, name:"LUGNARE", price:66, img:"images/bougie3.jpg", desc:"Arôme apaisant et chaud."}
];

const MOULDS = [
  {key:"Cœur", name:"Cœur", img:"images/mould-heart.jpg", surcharge:10},
  {key:"Fleur", name:"Fleur", img:"images/mould-flower.jpg", surcharge:8},
  {key:"Cylindrique", name:"Cylindrique", img:"images/mould-cyl.jpg", surcharge:0},
  {key:"Ourson", name:"Ourson", img:"images/mould-bear.jpg", surcharge:12}
];

const COLORS = ["Blanc crème","Rose pastel","Beige vanillé"];

const PACKS = [
  {id:201, key:"coffret", name:"Coffret cadeau en carton kraft", img:"images/pack1.jpg"},
  {id:202, key:"verre", name:"Boîte en verre avec ruban", img:"images/pack2.jpg"},
  {id:203, key:"sachet", name:"Sachet en tissu lin", img:"images/pack3.jpg"}
];
...
function getDiscountRate(totalQty){
  if(totalQty >= 4) return 0.35;
  if(totalQty === 3) return 0.25;
  if(totalQty === 2) return 0.20;
  return 0;
}
